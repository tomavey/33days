...
<cfset navargstoday["data-prefetch"] = "true">
		...
		<ul>
		<cfif isDefined("params.key") AND params.key NEQ 1 and params.controller is "biblestudies">
		...
		<cfif isDefined("params.key") and params.key LTE 32 and params.controller is "biblestudies">	
